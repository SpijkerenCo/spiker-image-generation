...
export default function Dashboard() {
  ...
  const handleGenerate = async (data: any) => {
    ...
    if (data.isStarting) {
      ...
      setStatus("Processing your request... Please wait");
    ...
    if (data.networkTimeout) {
      ...
      setStatus("Still processing... Paste the Drive folder URL when ready");
      return;
    }
    ...
    try {
      ...
      if (data.webhookResult && data.webhookResult.resultUrl) {
        ...
        if (data.shouldPoll) {
          setStatus("Generating images... Checking every 30 seconds");
